...
class TestWeaviateIntegration:
    ...
    def test_weaviate_connection(self, mock_config):
        ...
        with patch('cogent.providers.vector_store.cogent_vector_store.get_config') as mock_get_config:
            mock_get_config.return_value.vector_store.registered_vector_stores = mock_config["vector_store"]["registered_vector_stores"]
            mock_get_config.return_value.vector_store.vector_store_provider = mock_config["vector_store"]["vector_store_provider"]
            mock_get_config.return_value.vector_store.vector_store_collection_name = mock_config["vector_store"]["vector_store_collection_name"]
            mock_get_config.return_value.vector_store.vector_store_embedding_model_dims = mock_config["vector_store"]["vector_store_embedding_model_dims"]
...
class TestCogentVectorStoreUnit:
    ...
    def test_initialization(self, mock_config):
        ...
        with patch('cogent.providers.vector_store.cogent_vector_store.get_config') as mock_get_config:
            ...
            mock_get_config.return_value.vector_store.collection_name = mock_config["vector_store"]["vector_store_collection_name"]
            mock_get_config.return_value.vector_store.embedding_model_dims = mock_config["vector_store"]["vector_store_embedding_model_dims"]

            with patch('cogent.providers.vector_store.weaviate_vector_store.Weaviate') as mock_weaviate_class:
...
class TestWeaviateUnit:
    ...
    def test_initialization(self, mock_weaviate_client):
        ...
        with patch('cogent.providers.vector_store.weaviate_vector_store.weaviate') as mock_weaviate:
