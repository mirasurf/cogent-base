...
from cogent_base.config.utils import get_user_cogent_toml_path
...
class TestExtensibility(unittest.TestCase):
    ...
    @pytest.mark.unit
    @patch("cogent_base.config.core.load_toml_config")
    ...
    def test_user_base_toml_overrides_package(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            user_toml = get_user_cogent_toml_path(temp_dir_path)
...
dimensions = 1234
            ...
            os.chdir(temp_dir)
            try:
                config = CogentBaseConfig(config_dir=temp_dir_path)
    ...
    def test_package_base_toml_used_when_no_user_toml(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                self.assertEqual(config.llm.completion_provider, "ollama")
    ...
    def test_class_defaults_vs_package_defaults(self):
        ...
        self.assertEqual(llm_config.completion_model, "ollama_qwen_vision")
