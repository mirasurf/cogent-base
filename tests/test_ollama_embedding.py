...
class TestIntegrationOllamaEmbedding:
    ...
    async def test_ollama_object_embedding(self, mock_config, test_texts):
        ...
        with patch("cogent_base.embedding.ollama_embedding.get_cogent_config") as mock_get_config:
...
class TestUnitOllamaEmbedding:
    ...
    async def test_model_initialization(self, mock_config):
        ...
        with patch("cogent_base.embedding.ollama_embedding.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent_base.embedding.ollama_embedding.ollama") as mock_ollama:
    ...
    async def test_ollama_library_not_installed(self, mock_config):
        ...
        with patch("cogent_base.embedding.ollama_embedding.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent_base.embedding.ollama_embedding.ollama", None):
    ...
    async def test_non_ollama_model_error(self, mock_config):
        ...
        with patch("cogent_base.embedding.ollama_embedding.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent_base.embedding.ollama_embedding.ollama") as mock_ollama:
                ...
                with patch("cogent_base.embedding.ollama_embedding.initialize_ollama_model") as mock_init:
