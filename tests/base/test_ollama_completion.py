...
from cogent.base.completion.ollama_completion import OllamaCompletionModel
...
class TestIntegrationOllamaCompletion:
    ...
    async def test_ollama_basic_completion(self, mock_config, basic_request):
        ...
        with patch("cogent.base.completion.ollama_completion.get_cogent_config") as mock_get_config:
...
class TestUnitOllamaCompletion:
    ...
    async def test_model_initialization(self, mock_config):
        ...
        with patch("cogent.base.completion.ollama_completion.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent.base.completion.ollama_completion.ollama") as mock_ollama:
    ...
    async def test_ollama_library_not_installed(self, mock_config):
        ...
        with patch("cogent.base.completion.ollama_completion.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent.base.completion.ollama_completion.ollama", None):
    ...
    async def test_non_ollama_model_error(self, mock_config):
        ...
        with patch("cogent.base.completion.ollama_completion.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent.base.completion.ollama_completion.ollama") as mock_ollama:
                ...
                with patch("cogent.base.completion.ollama_completion.initialize_ollama_model") as mock_init:
