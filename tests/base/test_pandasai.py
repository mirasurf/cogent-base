...
from cogent.base.pandasai import (
    CogentPandasAI,
    DashScopePandasAI,
    PandasAIOnDashScope,
...
class TestDashScopePandasAI:
    ...
    @patch("cogent.base.pandasai.dashscope_pandasai.get_cogent_config")
...
class TestCogentPandasAI:
    ...
    @patch("cogent.base.pandasai.cogent_pandasai.get_cogent_config")
    @pytest.mark.unit
    def test_init_success(self, mock_get_config):
        ...
        # Mock factory
        with patch("cogent.base.pandasai.cogent_pandasai.PandasAIFactory.create_model") as mock_factory:
            mock_impl = Mock()
...
class TestIntegrationPandasAI:
    ...
    def test_dashscope_pandasai_full_workflow(self, sample_dataframe, mock_dashscope_config):
        ...
        with patch("cogent.base.pandasai.dashscope_pandasai.get_cogent_config") as mock_get_config:
            mock_config = Mock()
    ...
    def test_cogent_pandasai_full_workflow(self, sample_dataframe, mock_dashscope_config):
        ...
        with patch("cogent.base.pandasai.cogent_pandasai.get_cogent_config") as mock_get_config:
            mock_config = Mock()
            mock_config.llm.registered_models = mock_dashscope_config
            mock_get_config.return_value = mock_config
...
class TestSetupFunctions:
    ...
    def test_create_pandasai_agent_success(self, mock_get_config):
        ...
        with patch("cogent.base.pandasai.dashscope_pandasai.pai.config.set") as mock_config_set:
            with patch("cogent.base.pandasai.dashscope_pandasai.Agent") as mock_agent_class:
                mock_agent = Mock()
    ...
    def test_create_pandasai_agent_failure(self):
        ...
        # Mock import failure
        with patch("cogent.base.pandasai.dashscope_pandasai.pai", new=None):
            result = create_pandasai_agent(df, mock_llm)
