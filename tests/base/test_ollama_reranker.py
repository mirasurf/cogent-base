...
from cogent.base.reranker.ollama_reranker import OllamaReranker
...
class TestIntegrationOllamaReranker:
    ...
    async def test_ollama_reranker_integration(self):
        ...
        with patch("cogent.base.reranker.ollama_reranker.get_cogent_config", return_value=mock_config):
...
class TestUnitOllamaReranker:
    ...
    async def test_model_initialization(self, mock_config):
        ...
        with patch("cogent.base.reranker.ollama_reranker.get_cogent_config") as mock_get_config:
            mock_get_config.return_value.reranker.registered_rerankers = mock_config["reranker"]["registered_rerankers"]

            with patch("cogent.base.reranker.ollama_reranker.ollama") as mock_ollama:
    ...
    async def test_ollama_library_not_installed(self, mock_config):
        ...
        with patch("cogent.base.reranker.ollama_reranker.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent.base.reranker.ollama_reranker.ollama", None):
    ...
    async def test_non_ollama_model_error(self, mock_config):
        ...
        with patch("cogent.base.reranker.ollama_reranker.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent.base.reranker.ollama_reranker.ollama") as mock_ollama:
                ...
                with patch("cogent.base.reranker.ollama_reranker.initialize_ollama_model") as mock_init:
