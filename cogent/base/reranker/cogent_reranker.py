...
from cogent.base.config.consts import (
...
from cogent.base.reranker.base_reranker import BaseReranker
...
class CogentReranker(BaseReranker):
    ...
    def __init__(self, reranker_key: str):
        ...
        if self.provider == COGENT_RERANKER_PROVIDER_FLAG:
            from cogent.base.reranker.flag_reranker import FlagReranker
            ...
            from cogent.base.reranker.litellm_reranker import LiteLLMReranker
