...
from cogent.base.config.consts import COGENT_RERANKER_EMBEDDING_LITTELM, COGENT_RERANKER_EMBEDDING_OLLAMA
from cogent.base.embedding.base_embedding import BaseEmbeddingModel
